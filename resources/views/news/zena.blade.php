                ...
                <div class="item-card7-desc">
                    <div class="item-card7-text">
                        <a href="business.html" class="text-dark">
                            <h4 class="">{{$zena->title}}</h4>
                            <h6>{{$zena->label}}</h6>
                            <small>{{Carbon\Carbon::parse($zena->date)->format('D, M Y')}}</small>
                        </a>
                    </div>
                    <hr>
                    <p class="mb-0">{!!$zena->message!!}</p>
                </div>
            </div>

            <div class=" mb-0 overflow-hidden col-md-4 m-auto">
                <div class="item-card7-imgs">
                    <a href="business.html"></a>
                    <img src="{{asset('storage/news/'.$zena->image)}}" alt="img" class="cover-image">
                </div>
                <div class="item-card7-overlaytext">
                    <a href="business.htfoml" class="text-white"> <small> <span class="px-2">{{$zena->label}}</span>
                            <br><span class=>{{Carbon\Carbon::parse($zena->date)->format('M, D-Y')}} </span></small></a>
                </div>
            </div>
...
<section class="sptb">
    <div class="container">
        <div class="section-title center-block text-center">
            <h2>News</h2>
            <p>Subscribe to our news feed, to receive updates about our services and offers</p>
        </div>
        <div id="small-categories" class="owl-carousel owl-carousel-icons2 owl-loaded owl-drag">
            <div class="owl-stage-outer">
                <div class="owl-stage" style="transform: translate3d(-2883px, 0px, 0px); transition: all 0.25s ease 0s; width: 11532px;">
                    @foreach ($news as $zena)
                    <div class="owl-item" style="width: 455.5px; margin-right: 25px;">
                        <div class="item">
                            <div class="card mb-0 overflow-hidden">
                                ...
                                <div class="item-card7-overlaytext">
                                    <a href="business.htfoml" class="text-white"> <small> <span class="px-2">{{$zena->label}}</span>
                                            <br><span class=>{{Carbon\Carbon::parse($zena->date)->format('M, D-Y')}} </span></small></a>
                                    {{-- <a href="business.html" class="text-white"> </a> --}}
                                </div>
                    ...
                    <div class="owl-item cloned" style="width: 455.5px; margin-right: 25px;">
                        <div class="item">
                            <div class="card mb-0 overflow-hidden">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex">
                                        <div class="border-right w-150">
                                            <div class="p-3 text-center">
                                                <span class="font-weight-bold fs-16">--</span> Cities
                                            </div>
                                        </div>
